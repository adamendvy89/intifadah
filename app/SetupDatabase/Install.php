...
class Install
{
    ...
    {
        if (true ) return true;
        $eventRepository = app('App\\Repositories\\AdditionalEventRepository');

        $eventRepository->add('about-us', 'global.about-us', 'Your about us content goes here.....');
        $eventRepository->add('terms-and-condition', 'global.terms-and-condition', 'Your terms and condition content goes here.....');
        $eventRepository->add('privacy-policy', 'global.privacy-policy', 'Your private policy content goes here.....');
        $eventRepository->add('disclaimer', 'global.disclaimer', 'Your Disclaimer content goes here.....');
    }
