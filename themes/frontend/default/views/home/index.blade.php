                ...
                <div class="welcome-notes">
                    <div id="banner">
                      <div class="7u 12u(medium)">
                        <h2>Sistem Informasi Lembaga Dakwah Kampus</h2>
                        <p>Media Informasi dan Komunikasi Antar LDK Surabaya</p>
                      </div>
                      <!--<div class="5u 12u(medium)">
                        <ul>
                          <li><a href="#" class="button alt big icon fa-question-circle">Info Lebih Lanjut</a></li>
                        </ul>
                      </div>-->
                  </div>
                </div>
            ...
            <div class="right">
                ...
                <div class="login-social-links">
                    <div class="panel">
                        ...
                        <a href="{{URL::route('facebook-auth')}}" class="facebook"><i class="icon ion-social-facebook"></i> <span>Facebook</span></a>
                        @endif

                        @if(Config::get('enable-twitter-login'))
                        <a href="{{URL::route('twitter-auth')}}" class="twitter"><i class="icon ion-social-twitter"></i> <span>Twitter</span></a>
                        @endif
                ...
                <form id="login-form" role="form" action="user-home.php" method="post">
