<div class=" user media user-mini">
    ...
    <div class="media-body">
        ...
        <div class="action-buttons">
            <?php $status = $event->present()->likeStatus($user->id)?>
            ...
            @else
            <a href="{{URL::route('invite-member', ['type' => 'event', 'typeId' => $event->id, 'userid' => $user->id])}}" class="btn btn-success invite-member btn-xs" >{{trans('community.invite')}}</a>
            @endif
        </div>
