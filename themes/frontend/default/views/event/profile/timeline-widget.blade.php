<div data-lastcheck="" data-offset="{{\Config::get('post-per-event')}}" data-type="event-{{$eventId}}"   id="post-list">

    <?php $posts = app('App\\Repositories\\PostRepository')->lists('event-'.$eventId)?>
