            ...
            <ul class="nav clearfix">
                ...
                <li   class=" fileupload fileupload-exists" data-provides="fileupload">
                    ...
                    <a title="{{trans('post.attach-photos')}}"  class="btn-file">
                        ...
                        <input  id="post-image-input" multiple  class="" type="file" name="image[]">
                    </a>
                </li>
        ...
        <div class="editor-body">
            <div class="media post-textarea-container">
                <div class="media-object pull-left">
                    <img src="{{(isset($avatar)) ? $avatar : $loggedInUser->present()->getAvatar(50)}}" width="50" height="50"/>
                </div>
            ...
            <div id="post-type-content">
                ...
                <div id="post-editor-video-upload-container" class=" fileupload fileupload-exists" data-provides="fileupload">
                    <a class="btn-file">
                        ...
                        <input  id="post-editor-video-upload" multiple  class="" type="file" name="video">
                    </a>
                ...
                <li class="action-container">
                    ...
                    <div id="post-privacy-container" class="btn-group">
                        ...
                        @if (!isset($to) and !isset($offPrivacy))
                            <button class="btn btn-danger btn-sm dropdown-toggle" title="{{trans('post.who-see-this')}}" data-toggle="dropdown"><i class="icon ion-locked"></i> <span>{{Auth::user()->present()->postPrivacyName()}}</span> <i class="caret"></i></button>
