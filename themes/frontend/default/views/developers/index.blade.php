        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    Profile result for event
                    <ol>
                        <li><strong>title</strong>: Event title</li>
                        <li><strong>slug</strong>: Event slug</li>
                        <li><strong>category</strong>:Event category</li>
                        <li><strong>description</strong>: Event Description</li>
                        <li><strong>website</strong>: Event website</li>
                        <li><strong>logo</strong>: Event logo</li>
                        <li><strong>verified</strong>: If event is verified or not</li>
                        <li><strong>cover</strong>: Event profile cover photo</li>
                    </ol>
