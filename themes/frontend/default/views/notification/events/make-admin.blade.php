    ...
    <div class="media-body">
        <h5 class="media-heading">
            ...
            <?php
                switch($admin->type) {
                    case 1:
                        $trans = 'event.make-you-admin';
                        break;
                    case 2 :
                        $trans = "event.make-you-editor";
                        break;
                    default :
                        $trans = "event.make-you-moderator";
                        break;
                }
            ?>
            @if($admin->event)
                ...
                <a data-ajaxify="true" href="{{$admin->event->present()->url()}}">{{$admin->page->title}}</a>
            @else
