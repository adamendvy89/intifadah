...
<div class="box">
    <div class="box-title">{{trans('community.manage-community')}}</div>
    <div class="box-content">
        <ul class="nav">
            <li><a data-ajaxify="true" href="{{$community->present()->url('asatidz')}}"><b>Asatidz</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('khotbah')}}"><b>Jadwal Khotbah Jumat</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('event')}}"><b>Agenda Kegiatan</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('structure')}}"><b>Struktur Organisasi dan Job Desc</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('workprogram')}}"><b>Program Kerja</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('attendance')}}"><b>Absensi Kegiatan</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('point')}}"><b>Poin Anggota (SSKM)</b></a> </li>
            <li><a data-ajaxify="true" href="{{$community->present()->url('donation')}}"><b>Donasi</b></a> </li>
        </ul>
    </div>
</div>
