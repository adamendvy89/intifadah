    ...
    <div class="box-content">
        <form class="form-horizontal" role="form" action="" method="post">
                ...
                <div class="box-title">{{trans('global.privacy')}}</div>
                    ...
                    <div class="form-group">
                    <label class="col-sm-4 control-label">Siapa yang dapat posting</label>
                    <div class="col-sm-6 ">

                        <select name="val[can_post]">
                            <option {{($community->can_post == 1) ? 'selected' : null}} value="1">Semua Anggota</option>
                            <option {{($community->can_post == 0) ? 'selected' : null}} value="0">Hanya saya</option>
                        </select>
                    ...
                    <div class="form-group">
                    <label class="col-sm-4 control-label">Dapatkah orang lain mencari organisasi ini</label>
                    <div class="col-sm-6 ">

                        <select name="val[searchable]">
                            <option {{($community->searchable == 1) ? 'selected' : null}} value="1">Ya</option>
                            <option {{($community->searchable == 0) ? 'selected' : null}} value="0">Tidak</option>
                        </select>
                    ...
                    <div class="form-group">
                    <label class="col-sm-4 control-label">Siapa yang dapat mengundang anggota</label>
                    <div class="col-sm-6 ">

                        <select name="val[searchable]">
                            <option {{($community->can_invite == 1) ? 'selected' : null}} value="1">Semua Anggota</option>
                            <option {{($community->can_invite == 0) ? 'selected' : null}} value="0">Hanya saya</option>
                        </select>
                              ...
                              <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                  ...
                                  <a href="{{URL::route('community-delete', ['id' => $community->id])}}" class="delete-community btn btn-sm btn-danger pull-right">Hapus Organisasi</a>
                                </div>
                              </div>
